...
PImage imgZelda, img2, img3, img4, img5, img6, img7, img8, img9, img10, img11, img12, img13;
float x;
float y = 150.0;
int espacio;
int pantalla;
...
void setup(){
  ...
  img10 = loadImage("fondo2.jpg");
  img10.resize(1000,600);
  
  img11 = loadImage("fondo20.png");
  img11.resize(1000,600);
  
  img12 = loadImage("fondo4.jpg");
  img12.resize(1000,600);
  
  img13 = loadImage("fondo15.png");
  img13.resize(1000,600);
  
  // Personajes principales//
  img4 = loadImage("Link.png");
  img4.resize(450, 450);
  img5 = loadImage("Zelda.png");
  img5.resize(425, 425);
  // Personajes secudarios//
  img6 = loadImage("Mipha.png");
  img6.resize(250, 250);
  img7 = loadImage("Urbosa.png");
  img7.resize(250, 250);
  img8 = loadImage("Daruk.png");
  img8.resize(250,250);
  img9 = loadImage("Revali.png");
  img9.resize(250, 250);
   ...
   StartGame = minim.loadFile("LifeinRuins.mp3");
}
...
// Pantalla 2 Personajes principales//
  ...
  if(pantalla == 4){
    ...
    text("Jeremmy Alejandro Pacheco Tenorio", 220, y-350);
  ...
  if(pantalla == 5){
    image(img13, 0, 0);
    textSize(60);
    text("THANKS FOR WHATCHING", 100, 300);
    fill(0);
  }
}
void mousePressed(){
